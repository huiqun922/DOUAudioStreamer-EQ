...
-(BOOL)enable{
    ...
    return [DOUAudioVisualizer _sharedAnalyzer].isEnabled;
}
-(void)setEnable:(BOOL)enable{
    
    [[DOUAudioVisualizer _sharedAnalyzer] setEnabled:enable];
...
- (void)prepare
{
 ...
 // glColor4f(0.784f, 0.867f, 0.839f, 1.0f);
    glColor4f(179.f/255.f, 0.f/255.f, 0.f/255.f, 0.6f); //跳动颜色
