...
-(instancetype)initWithWithContentView:(UIView *)view clickCallBack:(ClickCallBack)clickCallBack andCloseCallBack:(CloseCallBack)closeCallBack;
{
    if (self = [super init]) {
        [self dl_setupNewWindow];
        [self dl_setupFrameNumber];
        [self dl_setupContentView];
        [self dl_setupContentView:view];
...
*/
    ...
    contentView.layer.borderColor = [[UIColor colorWithRed:53.f/255.f green:99.f/255.f blue:121.f/255.f alpha:1.0f] CGColor];
    self.contentView = contentView;
    [self.view addSubview:self.contentView];
}

-(void)dl_setupContentView:(UIView *)contentView
{
...
-(void)show
{
    ...
    [self dl_setupViewColor:[UIColor colorWithRed:0 green:0 blue:0 alpha:0.7] completion:^{
